<?php
    ...
    if(!isset($fupload) or empty($fupload) or $fupload ==''){
        $art_img = "../images/articles/no-image.png"; //можете    нарисовать net-avatara.jpg или взять в исходниках
	}          
    else {
    ...
    include ("bd.php");
    $date = date("d F Y");
    $result = mysql_query("INSERT INTO articles (headline,content,name_company,art_date,category,sub_category,image,size,version,pics,link) 
	VALUES('$title','$content', '$company_name', '$date' ,'$category', '$sub_category', '$art_img', '$size', '$version', '$pics', '$link')") or die(mysql_error());
